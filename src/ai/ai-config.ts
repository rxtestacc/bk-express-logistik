...
const AI_MODEL_DEFAULT = process.env.AI_MODEL || 'gemini-2.5-flash';

// A more powerful model for complex tasks like detailed document analysis.
const AI_PRO_MODEL_DEFAULT = process.env.AI_PRO_MODEL || 'gemini-2.5-pro';

// Fallback model in case the preferred ones are not available.
const AI_FALLBACK_MODEL = 'gemini-1.5-flash-latest';
